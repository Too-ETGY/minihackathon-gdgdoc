...
export default function NavbarForSearch({ onLocationSelect, onModeChange, currentMode }: NavbarProps) {
  ...
  return (
    <div className="absolute top-0 left-1/2 -translate-x-1/2 z-[1000] w-full max-w-6xl px-4 pt-4">
      <div className="bg-white rounded-2xl shadow-lg px-6 py-4 mb-4">
        <div className="flex items-center gap-6">
          ...
          <div className="relative flex-1">
            ...
            {isSearching && (
              <div className="absolute top-full mt-2 w-full bg-white border border-gray-200 rounded-lg shadow-xl p-4 text-center text-black">
                Mencari...
              </div>
            )}
          </div>
